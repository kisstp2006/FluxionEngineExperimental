...
public partial class Vector4Input : UserControl
{
    public static readonly StyledProperty<string?> HeaderProperty =
        AvaloniaProperty.Register<Vector4Input, string?>(nameof(Header));

    public static readonly StyledProperty<string> XProperty =
        AvaloniaProperty.Register<Vector4Input, string>(nameof(X), "0", defaultBindingMode: BindingMode.TwoWay);

    public static readonly StyledProperty<string> YProperty =
        AvaloniaProperty.Register<Vector4Input, string>(nameof(Y), "0", defaultBindingMode: BindingMode.TwoWay);

    public static readonly StyledProperty<string> ZProperty =
        AvaloniaProperty.Register<Vector4Input, string>(nameof(Z), "0", defaultBindingMode: BindingMode.TwoWay);

    public static readonly StyledProperty<string> WProperty =
        AvaloniaProperty.Register<Vector4Input, string>(nameof(W), "0", defaultBindingMode: BindingMode.TwoWay);
    ...
    public string W { get => GetValue(WProperty); set => SetValue(WProperty, value); }
    ...
    public Vector4Input() => InitializeComponent();
}
